...
class interface_index:
    ...
    def __init__(self, window):
        ...
        self.message['text'] = 'You can cancel de Analysis with Ctrl + c'
        ...
        self.message3['text'] = 'If Analysis fail by video format, try convert this'
        ...
        # Path video Input
        Label(frame, text='Video Path:', bg=color_section, bd=border_width).grid(row=1, column=0)
        ...
        # Url face input
        Label(frame, text='Faces Directory: ', bg=color_section, bd=border_width).grid(row=2, column=0)
        ...
        frame2 = LabelFrame(self.wind, text='Tools for Practice')
        ...
        Button(frame2, text='Convert Video to Required Format', command=self.convert, bg=color_button, bd=border_width).grid\
        ...
        # download Button
        Button(frame2, text='Download Video from Youtube', command=self.get_url_video, bg=color_button, bd=border_width).grid\
            (row=4, columnspan=2, sticky=W + E)
